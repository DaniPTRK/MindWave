"""ORM models for SQLAlchemy. Defines the database schema.
...
k-anonymity at the database level, so no employee can be identified
"""
...
class UserRole(str, enum.Enum):
    user = "user" # default user, could be an employee
    hr = "hr" # todo: flesh out HR role, add perms, make it more than just a label
...
class TokenBlocklist(Base):
    """Revoked JWT tracking for account deletion / logout"""
